...
import { Clock, MapPin, Calendar, Plus, Edit, Trash2 } from "lucide-react";
...
export default function TempleDetails() {
    ...
    // isAdmin check: compare user ID with temple.user (can be object or string)
        ...
        <div className="container mt-4 mb-5 animate-fade-in">
            ...
            <div className="row g-4">
                {nitis.length === 0 ? (
                    ...
                    nitis.map((niti, idx) => {
                        const nitiUploaderId = niti.updatedBy?._id ? niti.updatedBy._id.toString() : niti.updatedBy?.toString();
                                    ...
                                    <div className="card-body p-4 d-flex flex-column justify-content-between flex-grow-1">
                                        ...
                                        <div className="mt-auto">
                                            <div className="d-flex justify-content-center align-items-center gap-2 small text-dark fw-bold mb-3">
                                                ...
                                                {new Date(niti.startTime).toLocaleString()}
                                                {niti.endTime && ` – ${new Date(niti.endTime).toLocaleString()}`}
                                            </div>
                                            {canModify && (
